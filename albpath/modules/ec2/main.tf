resource "aws_instance" "instance_A" {
  ...
  user_data = <<-EOF
        ...
        echo "<h1>Instance One</h1>" | sudo tee /var/www/html/index.html
...
resource "aws_instance" "instance_B" {
  ...
  user_data = <<-EOF
        ...
        echo "<h1>Instance Two</h1>" | sudo tee /var/www/html/images/index.html
...
resource "aws_instance" "instance_C" {
  ...
  user_data = <<-EOF
        ...
        echo "<h1>Instance Three</h1>" | sudo tee /var/www/html/register/index.html
        sudo systemctl restart nginx
        EOF
  tags = {
    Name = "instance_C"
